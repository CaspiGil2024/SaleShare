...
const RAW_OPTIONS = [
  { value: 'Private', helper: 'עלות מלאה לפי סוג המשבצת - 1 מטבע לשעה' },
  {
    value: 'Shared',
    helper:
      'עלות מלאה למזמין כל עוד לא הצטרפו שותפים נוספים - לאחר מכן מתחלקת יחסית לפי (1 + מספר האורחים) של כל שותף',
  },
  { value: 'Dockside', helper: 'רתיקה בנמל - 1 מטבע לשעה' },
  {
    value: 'Cyprus',
    helper:
      'שייט ארוך לקפריסין - חובה לפחות שותף נוסף אחד, אחרת ההפלגה תבוטל אוטומטית במועד היציאה; העלות מתחלקת יחסית לפי (1 + מספר האורחים) של כל שותף',
  },
